from hgnn.datasets import load_ft
from hgnn.utils import hypergraph_utils as hgut


def load_feature_construct_H(fts, lbls, idx_train, idx_test,
                             m_prob=1,
                             K_neigs=[10],
                             is_probH=True,
    ...
    if use_mvcnn_feature or use_mvcnn_feature_for_structure:
        mvcnn_ft, lbls, idx_train, idx_test = fts, lbls, idx_train, idx_test
    if use_gvcnn_feature or use_gvcnn_feature_for_structure:
        gvcnn_ft, lbls, idx_train, idx_test = fts, lbls, idx_train, idx_test
