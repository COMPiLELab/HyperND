...
from sgc.normalization import fetch_normalization, row_normalize
...
def load_citation(dataset_str="cora", normalization="AugNormAdj", cuda=True):
    ...
    #print(features, adj, labels, idx_train, idx_val, idx_test)
    # porting to pytorch
    print(labels)
...
def prepare_data(data, normalization="AugNormAdj", cuda=True):
    """
    Load Citation Networks Datasets.
    """
